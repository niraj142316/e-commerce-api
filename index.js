...
app.use(cors()); //using this the react based project will connect to express.js project on the port 4000
...
// creating API for removing data 
...
app.post('/signup', async(req, res)=>{
    ...
    //generating token using data object
...
app.post('/login', async(req,res)=>{
    ...
    if(user){
        ...
        res.json({success:false, errorrs:"User not found"})
    }
})
